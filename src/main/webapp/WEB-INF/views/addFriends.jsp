        ...
        <section style="background-color: #50A1FF; " class="success text-center" id="addfriends" >
            ...
            <div class="text-center" align="center">
                ...
                <form action="addFriendButton" method="post">
                    ...
                    <input style="color: #2B3B50" type="text" name="userid">
                    <input type="submit" style="color: #ffffff; background-color: #2B3B50; font-size: 14px;" value="+">
                    <br>
                    <br>
                ...
                <div align="center" class="success text-center" style="margin-left: 5em; text-align: center">
                    <table align= "center">

                        <tr style="text-align: center; font-size: 24px; padding: 10px; margin: 10px;" align="center">

                            <th style="text-align: center; padding: 5px; margin: 5px;" align="center">NAME</th>
